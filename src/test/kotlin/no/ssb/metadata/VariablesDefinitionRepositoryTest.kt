...
@MicronautTest
class VariablesDefinitionRepositoryTest {
    ...
    @Test
    fun testRepository(){
        val variableDefinition = VariableDefinitionDAO(null, mapOf((SupportedLanguages.NB to "verdi"),(SupportedLanguages.EN to "value")),"test1",
