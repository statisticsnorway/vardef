...
val vardokResponseOk = VardokResponse(
    ...
    dc=DC(
        ...
        modified="2009-01-14",
        valid="1993-01-01 - ",
        description="Yrkesinntekter, kapitalinntekter, skattepliktige og skattefrie overføringer, i løpet av kalenderåret. Utlignet skatt og negative overføringer er trukket i fra.",
        ...
        rights="Statistiske metadata, produsert av Statistisk sentralbyrï¿½ (SSB) til produksjon av statistikk og annen alminnelig bruk.",
        source=null,
