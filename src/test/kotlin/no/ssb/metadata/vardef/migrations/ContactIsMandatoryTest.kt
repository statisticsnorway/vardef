...
class ContactIsMandatoryTest {
    ...
    @Test
    fun `test null contact values are populated with generated placeholder data`() {
        ...
        assertThat(postMigration.toMap()).isEqualTo(org.json.JSONObject(POST_CONTACT_IS_MANDATORY).toMap())
    }

    companion object {
        const val PRE_CONTACT_IS_MANDATORY = """{
  ...
  "lastUpdatedBy": "mmw@ssb.no"
        ...
        const val POST_CONTACT_IS_MANDATORY = """{
  "definitionId": "_JMd84Ch",
  "patchId": 1,
  "name": {
    "nb": "Landbakgrunn",
  ...
  "contact": {
    "title": {
      "nb": "$GENERATED_CONTACT_KEYWORD",
    },
    "email": "$GENERATED_CONTACT_KEYWORD@email.com"
  },
  "createdAt": "2025-02-06T11:05:05Z",
  "createdBy": "mmw@ssb.no",
  "lastUpdatedAt": "2025-02-06T11:05:05Z",
