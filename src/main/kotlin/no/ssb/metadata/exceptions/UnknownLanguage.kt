...
class UnknownLanguageExceptionHandler(private val errorResponseProcessor: ErrorResponseProcessor<Any>) : ExceptionHandler<UnknownLanguageException, HttpResponse<*>> {
