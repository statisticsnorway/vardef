...
const val UNIT_TYPES_FIELD_DESCRIPTION =
    "A list of one or more unit types, e.g. person, vehicle, household." +
        " Must be defined as codes from $KLASS_URL_WEB_BASE_DEFAULT/$KLASS_ID_UNIT_TYPES."
const val SUBJECT_FIELDS_FIELD_DESCRIPTION =
    "A list of subject fields that the variable is used in. " +
        "Must be defined as codes from $KLASS_URL_WEB_BASE_DEFAULT/$KLASS_ID_SUBJECT_FIELDS."
...
const val MEASUREMENT_TYPE_FIELD_DESCRIPTION =
    "Type of measurement for the variable, e.g. length, volume, currency. " +
        "Must be defined as codes from $KLASS_URL_WEB_BASE_DEFAULT/$KLASS_ID_MEASUREMENT_TYPE"
...
const val SHORT_NAME_QUERY_PARAM_DESCRIPTION = "List only the variable definition with the given short name."
