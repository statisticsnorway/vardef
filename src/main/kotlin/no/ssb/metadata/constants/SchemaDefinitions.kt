...
const val SUBJECT_FIELDS_FIELD_DESCRIPTION = "A list of subject fields that the variable is used in. " +
        "Must be defined as codes from https://www.ssb.no/klass/klassifikasjoner/618."
const val CONTAINS_UNIT_IDENTIFYING_INFORMATION_FIELD_DESCRIPTION = "True if variable instances contain information " +
        "which can identify a Person, Family or Household. Applies even if the information is pseudonymized."
const val CONTAINS_SENSITIVE_PERSONAL_INFORMATION_FIELD_DESCRIPTION = "True if variable instances contain particularly " +
...
const val MEASURMENT_TYPE_FIELD_DESCRIPTION = "Type of measurement for the variable, e.g. length, volume, currency. " +
...
const val RELATED_VARIABLE_DEFINITION_URIS_FIELD_DESCRIPTION = "Link(s) to related definitions of variables - " +
