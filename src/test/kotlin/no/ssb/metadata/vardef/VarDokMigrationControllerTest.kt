...
class VarDokMigrationControllerTest : BaseVardefTest() {
    ...
    @ValueSource(
        ints = [
            ...
            3251, 3253, 3256, 3310, 164, 171, 173, 177,
        ],
    )
    ...
    @ValueSource(
        ints = [
            69, 141, 590, 730, 746, 752, 753, 754, 755, 756, 871, 935, 936, 937,
            948, 964, 971, 973, 1264, 1265, 1267, 1268, 1282, 1355, 1396, 1473, 1841, 1997,
            2016, 2103, 2124, 2139, 2141, 2142, 2149, 2157, 2159, 2163, 2183, 2194, 2206, 2216, 2217, 2252, 2318, 2590,
            2633, 2677, 2690, 3007, 3008, 3009, 3010, 3011, 3126, 3325, 3394, 3398,
